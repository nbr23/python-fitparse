...
# *********** EXPORTED PROFILE FROM SDK VERSION 21.217 ON 2026-09-22 ***********
# ********* PARSED 216 TYPES (4758 VALUES), 125 MESSAGES (1572 FIELDS) *********
# ***************************** APPLIED 2 PATCHES ******************************
...
FIELD_TYPES = {
    ...
    'brazilian_grading_scale': FieldType(
        name='brazilian_grading_scale',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: '2',  # 2
            1: '3',  # 3
    ...
    'british_adjectival_grading_scale': FieldType(
        name='british_adjectival_grading_scale',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: 'M',  # M
            1: 'D',  # D
    ...
    'british_technical_grading_scale': FieldType(
        name='british_technical_grading_scale',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: '1',  # 1
            1: '2',  # 2
    ...
    'dankyu_grading_scale': FieldType(
        name='dankyu_grading_scale',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: '7_kyuu',  # 7 kyuu
            1: '6_kyuu',  # 6 kyuu
    ...
    'ewbank_grading_scale': FieldType(
        name='ewbank_grading_scale',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: '4',  # 4
            1: '5',  # 5
    ...
    'font_grading_scale': FieldType(
        name='font_grading_scale',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: '1',  # 1
            1: '2',  # 2
    ...
    'french_grading_scale': FieldType(
        name='french_grading_scale',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: '1',  # 1
            1: '2',  # 2
    ...
    'saxon_grading_scale': FieldType(
        name='saxon_grading_scale',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: 'I',  # I
            1: 'II',  # II
    ...
    'split_status': FieldType(  # Use with indoor climbing activities only
        name='split_status',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: 'failure',
    ...
    'uiaa_grading_scale': FieldType(
        name='uiaa_grading_scale',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: 'I',  # I
            1: 'II',  # II
    ...
    'vermin_grading_scale': FieldType(
        name='vermin_grading_scale',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: 'vb',  # VB
            1: 'v0',  # V0
    ...
    'yds_grading_scale': FieldType(
        name='yds_grading_scale',
        base_type=BASE_TYPES[0x00],  # enum
        values={
            0: '5_1',  # 5.1
            1: '5_2',  # 5.2
...
MESSAGE_TYPES = {
    ...
    18: MessageType(
        ...
        fields={
            ...
            10: Field(
                ...
                units='cycles',
                subfields=(
                    SubField(  # total number of pushes in a session
                        name='total_pushes',
                        def_num=10,
                        type=BASE_TYPES[0x86],  # uint32
                        units='pushes',
            ...
            18: Field(  # total_cycles / total_timer_time if non_zero_avg_cadence otherwise total_cycles / total_elapsed_time
                ...
                subfields=(
                    ...
                    SubField(  # average pushes per minute in a session
                        name='avg_push_cadence',
                        def_num=18,
                        type=BASE_TYPES[0x02],  # uint8
                        units='pushes/min',
                        ref_fields=(
            ...
            19: Field(
                ...
                subfields=(
                    ...
                    SubField(  # max pushes per minute in a session
                        name='max_push_cadence',
                        def_num=19,
                        type=BASE_TYPES[0x02],  # uint8
                        units='pushes/min',
                        ref_fields=(
    ...
    19: MessageType(
        ...
        fields={
            ...
            10: Field(
                ...
                units='cycles',
                subfields=(
                    SubField(  # total number of pushes in a lap
                        name='total_pushes',
                        def_num=10,
                        type=BASE_TYPES[0x86],  # uint32
                        units='pushes',
            ...
            17: Field(  # total_cycles / total_timer_time if non_zero_avg_cadence otherwise total_cycles / total_elapsed_time
                ...
                subfields=(
                    ...
                    SubField(  # average pushes per minute in a lap
                        name='avg_push_cadence',
                        def_num=17,
                        type=BASE_TYPES[0x02],  # uint8
                        units='pushes/min',
            ...
            18: Field(
                ...
                subfields=(
                    ...
                    SubField(  # max pushes per minute in a lap
                        name='max_push_cadence',
                        def_num=18,
                        type=BASE_TYPES[0x02],  # uint8
                        units='pushes/min',
            ...
            27: Field(  # North east corner latitude.
                name='nec_lat',
                type=BASE_TYPES[0x85],  # sint32
                def_num=27,
                units='semicircles',
            ),
            28: Field(  # North east corner longitude.
                name='nec_long',
                type=BASE_TYPES[0x85],  # sint32
                def_num=28,
                units='semicircles',
            ),
            29: Field(  # South west corner latitude.
                name='swc_lat',
                type=BASE_TYPES[0x85],  # sint32
                def_num=29,
                units='semicircles',
            ),
            30: Field(  # South west corner latitude.
                name='swc_long',
                type=BASE_TYPES[0x85],  # sint32
                def_num=30,
                units='semicircles',
    ...
    312: MessageType(
        ...
        fields={
            ...
            17: Field(  # North east corner latitude
                name='nec_lat',
                type=BASE_TYPES[0x85],  # sint32
                def_num=17,
                units='semicircles',
            ),
            18: Field(  # North east corner longitude
                name='nec_long',
                type=BASE_TYPES[0x85],  # sint32
                def_num=18,
                units='semicircles',
            ),
            19: Field(  # South west corner latitude
                name='swc_lat',
                type=BASE_TYPES[0x85],  # sint32
                def_num=19,
                units='semicircles',
            ),
            20: Field(  # South west corner longitude
                name='swc_long',
                type=BASE_TYPES[0x85],  # sint32
                def_num=20,
                units='semicircles',
            ...
            29: Field(
                ...
                subfields=(
                    ...
                    SubField(  # average pushes per minute in a split
                        name='avg_push_cadence',
                        def_num=29,
                        type=BASE_TYPES[0x84],  # uint16
                        units='pushes/min',
            ...
            30: Field(
                ...
                subfields=(
                    ...
                    SubField(  # max pushes per minute in a split
                        name='max_push_cadence',
                        def_num=30,
                        type=BASE_TYPES[0x84],  # uint16
                        units='pushes/min',
            ...
            31: Field(
                ...
                units='cycles',
                subfields=(
                    SubField(  # total number of pushes in a split
                        name='total_pushes',
                        def_num=31,
                        type=BASE_TYPES[0x86],  # uint32
                        units='pushes',
                    ...
                    SubField(  # total reps in a split round
                        name='total_reps',
                        def_num=31,
                        type=BASE_TYPES[0x86],  # uint32
                        units='reps',
            ...
            44: Field(  # Total time spent in the standing position
                name='time_standing',
                type=BASE_TYPES[0x86],  # uint32
                def_num=44,
                scale=1000,
            ...
            45: Field(  # Average left platform center offset
                name='avg_left_pco',
                type=BASE_TYPES[0x01],  # sint8
                def_num=45,
                units='mm',
            ),
            46: Field(  # Average right platform center offset
                name='avg_right_pco',
                type=BASE_TYPES[0x01],  # sint8
                def_num=46,
                units='mm',
            ),
            47: Field(  # Average left power phase angles. Data value indexes defined by power_phase_type.
                name='avg_left_power_phase',
                type=BASE_TYPES[0x02],  # uint8
                def_num=47,
                scale=0.7111111,
            ...
            48: Field(  # Average left power phase peak angles. Data value indexes defined by power_phase_type.
                name='avg_left_power_phase_peak',
                type=BASE_TYPES[0x02],  # uint8
                def_num=48,
                scale=0.7111111,
            ...
            49: Field(  # Average right power phase angles. Data value indexes defined by power_phase_type.
                name='avg_right_power_phase',
                type=BASE_TYPES[0x02],  # uint8
                def_num=49,
                scale=0.7111111,
            ...
            50: Field(  # Average right power phase peak angles. Data value indexes defined by power_phase_type.
                name='avg_right_power_phase_peak',
                type=BASE_TYPES[0x02],  # uint8
                def_num=50,
                scale=0.7111111,
            ...
            51: Field(  # Average power by position. Data value indexes defined by rider_position_type.
                name='avg_power_position',
                type=BASE_TYPES[0x84],  # uint16
                def_num=51,
                units='watts',
            ),
            52: Field(  # Maximum power by position. Data value indexes defined by rider_position_type.
                name='max_power_position',
                type=BASE_TYPES[0x84],  # uint16
                def_num=52,
                units='watts',
            ...
            58: Field(  # The flow score estimates how long distance wise a cyclist deaccelerates over intervals where deacceleration is unnecessary such as smooth turns or small grade angle intervals.
                name='avg_flow',
                type=BASE_TYPES[0x88],  # float32
                def_num=58,
                units='Flow',
            ),
            59: Field(  # The grit score estimates how challenging a route could be for a cyclist in terms of time spent going over sharp turns or large grade slopes.
                name='total_grit',
                type=BASE_TYPES[0x88],  # float32
                def_num=59,
                units='kGrit',
            ...
            63: Field(  # # of active lengths of swim pool
                name='num_active_lengths',
                type=BASE_TYPES[0x84],  # uint16
                def_num=63,
                units='lengths',
            ...
            67: Field(  # This is only set for split types that will trigger the end of a lap when the split ends
                name='first_lap_index',
                type=BASE_TYPES[0x84],  # uint16
                def_num=67,
            ),
            68: Field(  # This is only set for split types that will trigger the end of a lap when the split ends
                name='num_laps',
                type=BASE_TYPES[0x84],  # uint16
                def_num=68,
            ),
            69: Field(
                name='climb_grading_scale',
                type=FIELD_TYPES['climb_grading_scale'],
                def_num=69,
            ),
            70: Field(
                ...
                subfields=(
                    SubField(
                        ...
                        def_num=70,
                        type=FIELD_TYPES['brazilian_grading_scale'],
                        ref_fields=(
                            ReferenceField(
                                name='climb_grading_scale',
                                def_num=69,
                    ...
                    SubField(
                        ...
                        def_num=70,
                        type=FIELD_TYPES['british_adjectival_grading_scale'],
                        ref_fields=(
                            ReferenceField(
                                name='climb_grading_scale',
                                def_num=69,
                                value='british_adjectival',
                                raw_value=3,
                            ),
                        ),
                    ),
                    SubField(
                        ...
                        def_num=70,
                        type=FIELD_TYPES['british_technical_grading_scale'],
                        ref_fields=(
                            ReferenceField(
                                name='climb_grading_scale',
                                def_num=69,
                                value='british_technical',
                                raw_value=4,
                            ),
                        ),
                    ),
                    SubField(
                        ...
                        def_num=70,
                        type=FIELD_TYPES['dankyu_grading_scale'],
                        ref_fields=(
                            ReferenceField(
                                name='climb_grading_scale',
                                def_num=69,
                    ...
                    SubField(
                        ...
                        def_num=70,
                        type=FIELD_TYPES['ewbank_grading_scale'],
                        ref_fields=(
                            ReferenceField(
                                name='climb_grading_scale',
                                def_num=69,
                    ...
                    SubField(
                        ...
                        def_num=70,
                        type=FIELD_TYPES['font_grading_scale'],
                        ref_fields=(
                            ReferenceField(
                                name='climb_grading_scale',
                                def_num=69,
                    ...
                    SubField(
                        ...
                        def_num=70,
                        type=FIELD_TYPES['french_grading_scale'],
                        ref_fields=(
                            ReferenceField(
                                name='climb_grading_scale',
                                def_num=69,
                    ...
                    SubField(
                        ...
                        def_num=70,
                        type=FIELD_TYPES['saxon_grading_scale'],
                        ref_fields=(
                            ReferenceField(
                                name='climb_grading_scale',
                                def_num=69,
                    ...
                    SubField(
                        ...
                        def_num=70,
                        type=FIELD_TYPES['uiaa_grading_scale'],
                        ref_fields=(
                            ReferenceField(
                                name='climb_grading_scale',
                                def_num=69,
                    ...
                    SubField(
                        ...
                        def_num=70,
                        type=FIELD_TYPES['vermin_grading_scale'],
                        ref_fields=(
                            ReferenceField(
                                name='climb_grading_scale',
                                def_num=69,
                    ...
                    SubField(
                        ...
                        def_num=70,
                        type=FIELD_TYPES['yds_grading_scale'],
                        ref_fields=(
                            ReferenceField(
                                name='climb_grading_scale',
                                def_num=69,
            ...
            71: Field(  # Use with indoor climbing activities only
                name='status',
                type=FIELD_TYPES['split_status'],
                def_num=71,
            ),
            72: Field(  # Use with indoor climbing activities only
                name='num_falls',
                type=BASE_TYPES[0x84],  # uint16
                def_num=72,
            ),
            73: Field(  # Use with indoor climbing activities only
                name='climb_send',
            ...
            80: Field(  # fractional part of total_ascent
                name='total_fractional_ascent',
                type=BASE_TYPES[0x02],  # uint8
                def_num=80,
                scale=100,
            ...
            81: Field(  # fractional part of total_descent
                name='total_fractional_descent',
                type=BASE_TYPES[0x02],  # uint8
                def_num=81,
                scale=100,
            ...
            90: Field(
                ...
                subfields=(
                    ...
                    SubField(  # min pushes per minute in a split
                        name='min_push_cadence',
                        def_num=90,
                        type=BASE_TYPES[0x84],  # uint16
                        units='pushes/min',
                        ref_fields=(
            ...
            112: Field(
                name='dive_section_type',
                type=FIELD_TYPES['dive_section_type'],
                def_num=112,
            ),
            113: Field(
            ...
            120: Field(
                name='apnea_discipline',
                type=FIELD_TYPES['apnea_discipline'],
                def_num=120,
            ),
            121: Field(  # Average depth. 0 if above water
                name='avg_depth',
                type=BASE_TYPES[0x86],  # uint32
                def_num=121,
                scale=1000,
            ...
            122: Field(  # Max depth. 0 if above water
                name='max_depth',
                type=BASE_TYPES[0x86],  # uint32
                def_num=122,
                scale=1000,
            ...
            127: Field(  # Time since end of last dive
                name='surface_interval',
                type=BASE_TYPES[0x86],  # uint32
                def_num=127,
                units='s',
        ...
        fields={
            ...
            14: Field(
                ...
                subfields=(
                    ...
                    SubField(  # average pushes per minute in all splits of the type
                        name='avg_push_cadence',
                        def_num=14,
                        type=BASE_TYPES[0x84],  # uint16
                        units='pushes/min',
            ...
            15: Field(
                ...
                subfields=(
                    ...
                    SubField(  # max pushes per minute in all splits of the type
                        name='max_push_cadence',
                        def_num=15,
                        type=BASE_TYPES[0x84],  # uint16
                        units='pushes/min',
            ...
            16: Field(
                ...
                units='cycles',
                subfields=(
                    SubField(  # total number of pushes in all splits of the type
                        name='total_pushes',
                        def_num=16,
                        type=BASE_TYPES[0x86],  # uint32
                        units='pushes',
                    ...
                    SubField(  # total reps in all splits
                        name='total_reps',
                        def_num=16,
                        type=BASE_TYPES[0x86],  # uint32
                        units='reps',
            ...
            28: Field(  # Total time spent in the standing position
                name='left_right_balance',
                type=FIELD_TYPES['left_right_balance_100'],
                def_num=28,
            ),
            29: Field(  # Average left platform center offset
                name='time_standing',
                type=BASE_TYPES[0x86],  # uint32
                def_num=29,
                scale=1000,
            ...
            30: Field(  # Average right platform center offset
                name='avg_left_pco',
                type=BASE_TYPES[0x01],  # sint8
                def_num=30,
                units='mm',
            ),
            31: Field(  # Average left power phase angles. Data value indexes defined by power_phase_type.
                name='avg_right_pco',
                type=BASE_TYPES[0x01],  # sint8
                def_num=31,
                units='mm',
            ),
            32: Field(  # Average left power phase peak angles. Data value indexes defined by power_phase_type.
                name='avg_left_power_phase',
                type=BASE_TYPES[0x02],  # uint8
                def_num=32,
                scale=0.7111111,
            ...
            33: Field(  # Average right power phase angles. Data value indexes defined by power_phase_type.
                name='avg_left_power_phase_peak',
                type=BASE_TYPES[0x02],  # uint8
                def_num=33,
                scale=0.7111111,
            ...
            34: Field(  # Average right power phase peak angles. Data value indexes defined by power_phase_type.
                name='avg_right_power_phase',
                type=BASE_TYPES[0x02],  # uint8
                def_num=34,
                scale=0.7111111,
            ...
            35: Field(  # Average power by position. Data value indexes defined by rider_position_type.
                name='avg_right_power_phase_peak',
                type=BASE_TYPES[0x02],  # uint8
                def_num=35,
                scale=0.7111111,
            ...
            36: Field(  # Maximum power by position. Data value indexes defined by rider_position_type.
                name='avg_power_position',
                type=BASE_TYPES[0x84],  # uint16
                def_num=36,
                units='watts',
            ...
            42: Field(  # The flow score estimates how long distance wise a cyclist deaccelerates over intervals where deacceleration is unnecessary such as smooth turns or small grade angle intervals.
                name='avg_combined_pedal_smoothness',
                type=BASE_TYPES[0x02],  # uint8
                def_num=42,
                scale=2,
            ...
            43: Field(  # The grit score estimates how challenging a route could be for a cyclist in terms of time spent going over sharp turns or large grade slopes.
                name='avg_flow',
                type=BASE_TYPES[0x88],  # float32
                def_num=43,
                units='Flow',
            ...
            60: Field(  # Distance of the longest split
                name='max_distance',
                type=BASE_TYPES[0x86],  # uint32
                def_num=60,
                scale=100,
            ...
            66: Field(  # fractional part of total_ascent
                name='total_fractional_ascent',
                type=BASE_TYPES[0x02],  # uint8
                def_num=66,
                scale=100,
            ...
            67: Field(  # fractional part of total_descent
                name='total_fractional_descent',
                type=BASE_TYPES[0x02],  # uint8
                def_num=67,
                scale=100,
            ...
            68: Field(  # fractional part of avg_ascent
            ...
            69: Field(  # fractional part of max_descent
    ...
    227: MessageType(  # Value from 1 to 100 calculated by FirstBeat
        ...
        fields={
            ...
            3: Field(  # Undocumented Garmin Body Battery level (0-100)
                name='body_battery',
                type=BASE_TYPES[0x01],  # sint8
                def_num=3,
                units='percent',
